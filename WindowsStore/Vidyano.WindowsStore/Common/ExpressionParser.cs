...
namespace Vidyano.Common
{
    internal static class ExpressionParser
    {
        ...
        private static readonly ConcurrentDictionary<string, Func<int, bool>> cache = new ConcurrentDictionary<string, Func<int, bool>>();
        private static readonly string[] operands = new[] { "<=", ">=", "<", ">", "!=", "=" };
