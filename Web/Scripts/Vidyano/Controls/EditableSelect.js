...
(function ($) {
    ...
    $.fn.editableSelectInstances = function () {
        ...
        $(this).each(function () {
            var $this = $(this);
            if ($this.data('editable-selecter') != null)
                ret.push(instances[$this.data('editable-selecter')]);
        });
        return ret;
    };
    ...
    EditableSelect.prototype = {
        ...
        duplicateOptions: function () {
            ...
            //var liLeeg = $('<li>&nbsp;</li>');
            //context.initListItemEvents(liLeeg);
            //option_list.append(liLeeg);
            context.text.val(context.settings.selectedValue);
            context.current_value = context.settings.selectedValue;
        ...
        initInputEvents: function (text) {
            ...
            text.focus(
              ...
              function (e) {
                  ...
                  context.settings.onSelect($(this).val());
              }
            ).keyup(
              function () {
        ...
        pickListItem: function (list_item) {
            ...
            if (typeof this.settings.onSelect == 'function') {
                this.settings.onSelect(this.current_value);
            };
            this.hideList();
        },
        ...
        positionElements: function () {
            ...
            this.wrapper.show();
            this.list_item_height = items[0].offsetHeight;
