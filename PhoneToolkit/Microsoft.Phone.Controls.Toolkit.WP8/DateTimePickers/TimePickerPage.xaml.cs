...
namespace Microsoft.Phone.Controls
{
    ...
    public partial class TimePickerPage : DateTimePickerPageBase
    {
        ...
        public TimePickerPage()
        {
            ...
            var ok = ApplicationBar.Buttons[0] as ApplicationBarIconButton;
            ok.Text = (string)Application.Current.Resources["DateTimePickerOKText"];
            var cancel = ApplicationBar.Buttons[1] as ApplicationBarIconButton;
            cancel.Text = (string)Application.Current.Resources["DateTimePickerCancelText"];

            HeaderTitle.Text = (string)Application.Current.Resources["DateTimePickerChooseTime"] ?? "CHOOSE TIME";
        }
